        ...
        <main class="app">
            <section class="content grid-y">
                ...
                <div class="body grid-x justify-center">
                    ...
                    %>
                    <form action="${pageContext.request.contextPath}/manager/executeUpdateUtente"
                          method="post" class="app justify-center align-center" enctype="multipart/form-data">
                        <fieldset class="grid-y cell w50 create">
                            <h2 id="login" style="text-align: center">Aggiorna i dati dell'utente</h2>

                            <label for="username" class="field">Nickname dell'utente</label> <br>
                            <input type="text" minlength="5" maxlength="50" id="username" name="username" value="<%=user.getNickname()%>" readonly> <br>
