    ...
    <main class="app">
      <section class="content grid-y">
        ...
        <div class="body grid-x justify-center">
          ...
          %>
          <form action="${pageContext.request.contextPath}/manager/executeUpdateCorso"
            ...
            <fieldset class="grid-y cell w50 create">
              ...
              <label for="nome" class="field">Nome del corso</label> <br>
                <input type="text" minlength="5" maxlength="50" id="nome" name="nome" value="<%=corso.getNome()%>"> <br>
              ...
              <label for="prezzo" class="field">Prezzo di base</label> <br>
                <input type="number" step=".25" id="prezzo" name="prezzo" value="<%=corso.getPrezzoBase()%>"> <br>
              <p id="prezzerr" class="err">Il prezzo deve essere un decimale</p> <br>
              <label for="content" class="field">Contenuto</label> <br>
                <textarea id="content" rows="10" maxlength="10000" name="content"><%=corso.getTesto()%></textarea> <br>
